...
export default function StateReturns() {
  ...
  const diasTranscurridos  = campana.diasTranscurridos || 0;
    ...
    <div>
      <div className="tabar-page-header">
        ...
        <p style={{ margin: 0, color: "#8B949E", fontSize: "13px" }}>
          Proyección y detalle de rendimiento sobre tu inversión FET
        </p>
      </div>

      {myBalance === 0 && (
        <div className="tabar-notice">
          Aún no tenés inversión FET. Invertí desde la sección anterior para ver tus rendimientos.
        </div>
      )}
