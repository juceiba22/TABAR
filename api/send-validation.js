export default async function handler(req, res) {
  ...
  if (role === "producer") {
    ...
    welcomeText = "Te damos la bienvenida a la plataforma TABAR como Acopiador/Industria. Ahora podrás registrar tus órdenes de compra, coordinar financiamientos y validar fardos certificados.";
  } else if (role === "state") {
    welcomeText = "Te damos la bienvenida a la plataforma TABAR en tu carácter de Entidad Estatal / Administrador del FET. Ahora podrás auditar transacciones, verificar cumplimiento tributario y supervisar la trazabilidad tabacalera.";
  } else if (role === "dealer") {
  ...
  // Diseño HTML Dark Luxury compatible con clientes de correo
...
<body style="margin: 0; padding: 0; background-color: #121212; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #E0E0E0; -webkit-font-smoothing: antialiased;">
  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #121212; padding: 40px 20px;">
    <tr>
      <td align="center">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #1a1a1a; border-radius: 16px; border: 1px solid rgba(227, 182, 79, 0.2); box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5); overflow: hidden; padding: 40px 30px;">
          <!-- LOGO -->
          <tr>
            <td align="center" style="padding-bottom: 30px;">
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background-color: #121212; border: 1px solid #E3B64F; border-radius: 8px; width: 44px; height: 44px; text-align: center; vertical-align: middle; color: #E3B64F; font-size: 24px; font-weight: bold; line-height: 44px; font-family: serif;">
                    T
                  </td>
              ...
              <div style="font-size: 10px; color: #E3B64F; letter-spacing: 2px; margin-top: 5px; text-transform: uppercase; font-weight: 600;">
          ...
          <tr>
            <td align="center" style="padding-bottom: 25px;">
              ...
              <p style="color: #E3B64F; font-size: 14px; font-weight: 500; margin: 5px 0 0 0; text-transform: uppercase; letter-spacing: 1.5px;">
                Rol: ${roleName}
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding-bottom: 30px;">
              <p style="font-size: 16px; line-height: 1.6; color: #E0E0E0; margin: 0 0 15px 0;">
                Estimado/a <strong>${firstName} ${lastName}</strong>,
              </p>
              ...
              <div style="background-color: rgba(227, 182, 79, 0.04); border: 1px solid rgba(227, 182, 79, 0.1); border-radius: 8px; padding: 20px; margin-bottom: 25px;">
                <h3 style="color: #E3B64F; font-size: 13px; font-weight: 700; margin: 0 0 12px 0; text-transform: uppercase; letter-spacing: 1px;">
                  Detalles de la Entidad
                </h3>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td style="font-size: 14px; color: #888888; padding: 4px 0; font-family: sans-serif;">Organización:</td>
                    <td style="font-size: 14px; color: #FFFFFF; font-weight: 600; padding: 4px 0; text-align: right; font-family: sans-serif;">${companyName}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td style="font-size: 14px; color: #E3B64F; font-weight: 600; padding: 4px 0; text-align: right; font-family: sans-serif;">Pendiente de Validación</td>
                  </tr>
                </table>
              </div>
          ...
          <tr>
            <td align="center" style="padding-bottom: 40px;">
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="background-color: #E3B64F; border-radius: 8px;">
          ...
          <tr>
            <td align="center" style="border-top: 1px solid rgba(255, 255, 255, 0.05); padding-top: 25px;">
              ...
              <p style="font-size: 12px; color: #E3B64F; font-weight: 600; margin: 10px 0 0 0; letter-spacing: 1px; text-transform: uppercase;">
  ...
  try {
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "Tabar <soporte@agrotabaco-labs.com>",
        to: email,
        subject: `¡Bienvenido/a a Tabar! Alta del usuario ${firstName} ${lastName}`,
        html: htmlBody
      })
    });
